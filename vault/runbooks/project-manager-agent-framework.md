---
date: 2026-03-22
tags: [agents, framework, project-management]
status: active
source: curated
---
...
## Zweck
Dieses Framework hält fest, wie ein Projektmanager/Main-Agent Arbeit steuert, Entlastung organisiert und den Einsatz unterstützender Agents bewusst verbessert, ohne Kontrollverlust oder Agent-Chaos zu erzeugen.

## Kernprinzip
Der Main-Agent trägt Führung, Priorisierung, Integrationsentscheidungen und die Verantwortung für den Gesamtpfad.
...
- Was ist hier die eigentliche Kernentscheidung?
...
- kleine Mini-Recherchen
- Datenpflege und Datenaufbereitung
- Dubletten-/Widerspruchsmarkierung
- Doku-, Backlog- und Notizpflege
- Gegenlesen klar abgegrenzter Teilabschnitte
...
- Relevante Beobachtungen werden knapp dokumentiert.
- In regelmäßigen Abständen werden daraus konkrete Verbesserungsmaßnahmen abgeleitet.
- Wenn sich daraus sinnvolle Anpassungen an Agent-.md-Dateien, Rollenprofilen oder Arbeitsregeln ergeben, sollen diese als klare, praktische Änderungsvorschläge an Y. Hatabi kommuniziert werden.

## Regel für bestehende und künftige Agents
Jede Agent-.md-Datei soll eine Regel zur kontinuierlichen Selbstanalyse enthalten:
- eigene Performance beobachten
- Erkenntnisse dokumentieren
- in sinnvollen Abständen auswerten
- nur handfeste, begründete Verbesserungen vorschlagen
- keine eigenmächtige Rollenausweitung unter dem Vorwand der Selbstoptimierung

## Zielbild
Ein gutes Agent-System verbessert sich nicht zufällig, sondern beobachtungsbasiert.
Es lernt aus realer Arbeit, passt Leitplanken gezielt an und erhöht so schrittweise Qualität, Effizienz und Fokus — ohne unkontrollierte Rollenexpansion.